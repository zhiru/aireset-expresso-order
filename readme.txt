...
= 1.1.45 =
* O pacote de release agora gera somente o zip canonico do plugin, com estrutura correta para importacao no WordPress e com o license manager ofuscado no dist.
